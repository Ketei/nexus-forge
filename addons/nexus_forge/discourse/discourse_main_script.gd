...
## ------------------------------ SCENES ------------------------------
## Done
#const DIALOG_NODE = preload("res://dialog_graph_node.gd")
## Done
#const CHOICE_GRAPH_NODE = preload("res://addons/nexus_forge/scenes/discourse/dialog_nodes/choice_graph_node.tscn")
## Done
#const BRANCH_NODE = preload("res://addons/nexus_forge/scenes/discourse/dialog_nodes/cond_dialog_graph_node.tscn")
## Done
...
#func create_new_dialog_node(dialog_data: Dictionary = {}) -> DiscourseGraphNode:
	#var new_dialog: DiscourseGraphNode = DIALOG_NODE.new(&"", true)
	#if not dialog_data.is_empty():
		#new_dialog._set_node_data(dialog_data)
	#
	#new_dialog.duplicate_requested.connect(duplicate_node)
	#new_dialog.close_requested.connect(delete_node)
	#new_dialog.node_updated.connect(_on_something_changed)
	#
	#return new_dialog
#
#
#func create_new_choices_node(choices_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_choices.node_updated.connect(_on_something_changed)
	#new_choices.close_requested.connect(delete_node)
	#new_choices.duplicate_requested.connect(duplicate_node)
	#
	#return new_choices
#
#
#func create_new_random_node(random_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_random.node_updated.connect(_on_something_changed)
	#new_random.close_requested.connect(delete_node)
	#new_random.duplicate_requested.connect(duplicate_node)
	#
	#return new_random
#
#
#func create_new_wait_node(wait_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_wait.node_updated.connect(_on_something_changed)
	#new_wait.close_requested.connect(delete_node)
	#new_wait.duplicate_requested.connect(duplicate_node)
	#
	#return new_wait
#
#
...
#func create_new_jump_pointer(jump_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_pointer.node_updated.connect(_on_something_changed)
	#new_pointer.close_requested.connect(delete_node)
	#new_pointer.duplicate_requested.connect(duplicate_node)
	#
	#return new_pointer
#
#
#func create_new_jump_target(jump_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_target.duplicate_requested.connect(duplicate_node)
	#
	#return new_target
#
#
...
#func create_new_end_node(end_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_end.duplicate_requested.connect(duplicate_node)
	#
	#return new_end
#
#
#func create_new_event_node(event_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_event.duplicate_requested.connect(duplicate_node)
	#
	#return new_event
#
#
#func create_new_signal_node(signal_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_signal.node_updated.connect(_on_something_changed)
	#new_signal.close_requested.connect(delete_node)
	#new_signal.duplicate_requested.connect(duplicate_node)
	#
	#return new_signal
#
#
#func create_new_value_node(value_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_value.node_updated.connect(_on_something_changed)
	#new_value.close_requested.connect(delete_node)
	#new_value.duplicate_requested.connect(duplicate_node)
	#
	#return new_value
#
#
#func create_new_set_var_node(var_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_set_var.node_updated.connect(_on_something_changed)
	#new_set_var.close_requested.connect(delete_node)
	#new_set_var.duplicate_requested.connect(duplicate_node)
	#return new_set_var
#
#
#func create_new_cond_var_node(cond_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_cond_var.node_updated.connect(_on_something_changed)
	#new_cond_var.close_requested.connect(delete_node)
	#new_cond_var.duplicate_requested.connect(duplicate_node)
	#return new_cond_var
#
#
#func create_new_cond_dialog_node(cond_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_cond_dialog.duplicate_requested.connect(duplicate_node)
...
#func create_new_match_node(match_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_match.node_updated.connect(_on_something_changed)
	#new_match.close_requested.connect(delete_node)
	#new_match.duplicate_requested.connect(duplicate_node)
	#return new_match
#
#
#func create_new_comparation_node(comp_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_comp.node_updated.connect(_on_something_changed)
	#new_comp.close_requested.connect(delete_node)
	#new_comp.duplicate_requested.connect(duplicate_node)
	#return new_comp
#
#
#func create_new_math_node(math_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#new_math.node_updated.connect(_on_something_changed)
	#new_math.close_requested.connect(delete_node)
	#new_math.duplicate_requested.connect(duplicate_node)
	#return new_math
#
#
#func create_new_call_node(call_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_call.node_updated.connect(_on_something_changed)
	#new_call.close_requested.connect(delete_node)
	#new_call.duplicate_requested.connect(duplicate_node)
	#
	#return new_call
#
#
#func create_new_return_call_node(call_data: Dictionary = {}) -> DiscourseGraphNode:
	...
	#
	#new_return.node_updated.connect(_on_something_changed)
	#new_return.close_requested.connect(delete_node)
	#new_return.duplicate_requested.connect(duplicate_node)
	#
	#return new_return
#
#
...
#
#
#func duplicate_node(target_node: DiscourseGraphNode) -> void:
