...
func operator_to_range(operator: NFQuestRes.ConnectFlags) -> int:
	match operator:
		NFQuestRes.OperatorFlags.EQUAL:
			return 0
		NFQuestRes.OperatorFlags.NOT:
			return 1
		NFQuestRes.OperatorFlags.LESS_THAN:
			return 2
		NFQuestRes.OperatorFlags.MORE_THAN:
			return 3
		NFQuestRes.OperatorFlags.EQUAL_OR_LESS:
			return 4
		NFQuestRes.OperatorFlags.EQUAL_OR_MORE:
			return 5
		NFQuestRes.OperatorFlags.EQUAL:
			return 6
		_:
...
func range_to_operator(range: int) -> NFQuestRes.OperatorFlags:
	match range:
		0:
