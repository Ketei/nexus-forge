...
# --------------------- Good -----------------------------------------
# ------------------------------ SCENES ------------------------------
const CHOICE_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/choice_graph_node.tscn")
const CONDITION_SET_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/condition_set_graph_node.tscn")
const COND_DIALOG_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/cond_dialog_graph_node.tscn")
const DIALOG_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/dialog_graph_node.tscn")
const END_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/end_graph_node.tscn")
const ENTRY_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/entry_graph_node.tscn")
const EVAL_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/eval_graph_node.tscn")
const EVENT_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/event_graph_node.tscn")
const JUMPER_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/jumper_graph_node.tscn")
const JUMP_TARGET_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/jump_target_node.tscn")
const MATCH_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/match_graph_node.tscn")
const MATH_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/math_graph_node.tscn")
const PAUSE_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/pause_graph_node.tscn")
const RANDOM_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/random_graph_node.tscn")
const SET_VAR_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/set_var_graph_node.tscn")
const SIGNAL_EMIT_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/signal_emit_graph_node.tscn")
const VALUE_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/value_graph_node.tscn")
const WAIT_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/wait_graph_node.tscn")
const CALL_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/call_graph_node.tscn")
const CALL_RETURN_GRAPH_NODE = preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/call_return_graph_node.tscn")
# ------------------------------ SCRIPTS ------------------------------
const ConvFileDialog = preload("res://addons/nexus_forge/tools/discourse/conv_file_dialog.gd")
const UnsavedDialogScript = preload("res://addons/nexus_forge/tools/discourse/unsaved_dialog_script.gd")
# ---------------------------------------------------------------------
...
func create_new_start_node(start_data: Dictionary = {}) -> DiscourseGraphNode:
	var new_start := preload("res://addons/nexus_forge/tools/discourse/dialog_nodes/entry_graph_node.tscn").instantiate()
...
func on_connection_to_empty(from_node: StringName, from_port: int, release_position: Vector2, to_empty: bool) -> void:
	if not Input.is_action_pressed(&"left_control_key"):
		return
...
func _on_main_menu_mnbtn_id_selected(id: int) -> void:
	match id:
		0: # New
			var new_loader := ConvFileDialog.new()
			new_loader.file_mode = FileDialog.FILE_MODE_SAVE_FILE
		...
		1: # Open
			var new_loader := ConvFileDialog.new()
			new_loader.file_mode = FileDialog.FILE_MODE_OPEN_FILE
			add_child(new_loader)
			new_loader.show()
