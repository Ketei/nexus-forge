...
func _on_create_fac_db_pressed() -> void:
	...
	new_res_selector.file_mode = FileDialog.FILE_MODE_SAVE_FILE
...
func _on_load_fact_db_pressed() -> void:
	...
	new_res_selector.file_mode = FileDialog.FILE_MODE_OPEN_FILE
...
func _on_create_faction_pressed() -> void:
	var fac_conf :=  preload("res://addons/nexus_forge/classes/line_edit_confirmation_dialog.gd").new()
