...
static func get_file_browser() -> FileDialog:
	if Engine.is_editor_hint():
		return load("res://addons/nexus_forge/classes/resource_file_dialog_editor.gd").new()
	else:
		return load("res://addons/nexus_forge/classes/resource_file_dialog.gd").new()
