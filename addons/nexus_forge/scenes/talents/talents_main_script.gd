...
const LineEditConfirmationDialog = preload("res://addons/nexus_forge/scenes/line_edit_confirmation_dialog.gd")
...
@onready var skill_desc_txt_edt: TextEdit = $MainContainer/SkillsContainer/DesContainer/SkillDescTxtEdt
#@onready var initial_skill_level_spn_bx: SpinBox = $MainContainer/SkillsContainer/RangeContainer/InitialContainer/InitialSkillLevelSpnBx
#@onready var skill_limit_spn_bx: SpinBox = $MainContainer/SkillsContainer/RangeContainer/MaxContainer/SkillLimitSpnBx
@onready var skill_data_tree: IDTree = $MainContainer/SkillsContainer/DataContainer/SkillDataTree
@onready var skill_int_btn: Button = $MainContainer/SkillsContainer/DataContainer/DataHeader/ButtonContainer/SkillIntBtn
@onready var skill_flt_btn: Button = $MainContainer/SkillsContainer/DataContainer/DataHeader/ButtonContainer/SkillFltBtn
@onready var skill_bool_btn: Button = $MainContainer/SkillsContainer/DataContainer/DataHeader/ButtonContainer/SkillBoolBtn
@onready var skill_str_btn: Button = $MainContainer/SkillsContainer/DataContainer/DataHeader/ButtonContainer/SkillStrBtn
@onready var main_panel: HBoxContainer = $MainContainer
...
func on_create_skill_pressed() -> void:
	...
	id_creator.accept_empty = false
	id_creator.clean_string = true
	id_creator.title = "Create Skill"
	id_creator.ok_button_text = "Create"
	id_creator.invalid_strings = talents_resource.get_skills()
	add_child(id_creator)
	id_creator.show()
	id_creator.focus_line_edit()
	
	var result = await id_creator.dialog_confirmed
